...
[V0.6.3 产品 Latest](https://github.com/hejiahang0001-oss/dsh-desktop/releases/tag/v0.6.3) 新增原生 Wiki 中心：可选择/初始化本地 Markdown 知识库、按页面路径与来源查询，并从当前会话选择一条助手结论，经预览和确认后保存。基础能力不依赖 Git、Python、QMD、Obsidian 或 Codex 安装。V0.6.3 已作为 GitHub Pre-release 发布，V0.5.4 继续保持 Stable 和首页下载版本。

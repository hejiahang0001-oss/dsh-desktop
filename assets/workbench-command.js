(() => {
  ...
  const commands = Object.freeze([
    ...
    { id: 'terminal.open', title: '打开官方终端', detail: '使用官方侧栏多终端；输出不会自动交给助手', shortcut: 'Ctrl+Alt+T', run: () => api.terminal.openOfficial() },
    { id: 'terminal.focus', title: '打开兼容终端', detail: '隔离终端；助手读取输出时会先请求你的授权', shortcut: 'Ctrl+Alt+K', run: () => api.terminal.openWindow() },

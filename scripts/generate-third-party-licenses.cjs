...
const harnessModules = path.join(root, 'vendor', 'harness-hoisted-0.1.2-alpha.1', 'node_modules');
...
if (packages.length !== 529) throw new Error(`Expected 529 packaged JavaScript packages, found ${packages.length}.`);

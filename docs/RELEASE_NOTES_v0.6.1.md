...
- Implementation PR [#41](https://github.com/hejiahang0001-oss/dsh-desktop/pull/41) and the follow-up main CI run pass all three Windows jobs. The non-draft [V0.6.1 Pre-release](https://github.com/hejiahang0001-oss/dsh-desktop/releases/tag/v0.6.1) targets exact merge `4d7a3fa33b80522c488d12fc8308d9165d3e5f08`.
- GitHub reports all three remote sizes and digests equal to local evidence. A public clean download reproduces all three SHA-256 values and passes both entries in the downloaded checksum manifest. GitHub formal Latest remains V0.5.4.

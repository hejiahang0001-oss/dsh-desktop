...
> Generated by `scripts/generate-third-party-licenses.cjs` from the exact V1.1.6 packaged runtime manifests. Do not edit package rows manually.
...
| @deepseek-ai/dsh-e2b | 0.1.2-rc.1 |
...
| @deepseek-ai/dsh-session-snapshot | 0.1.2-rc.1 |
...
| @deepseek-ai/dsh-session-title-all-prompts-llm | 0.1.2-rc.1 |
...
| @deepseek-ai/dsh-subagent-dsh-sdk | 0.1.2-rc.1 |

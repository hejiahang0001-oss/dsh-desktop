...
> Generated by `scripts/generate-third-party-licenses.cjs` from the exact V1.1.10 packaged runtime manifests. Do not edit package rows manually.
...
- JavaScript packages inventoried: **545**; no package in this fixed set is missing a declared license identifier.
...
| @deepseek-ai/dsh-client-web | 0.1.3-alpha.2 |
...
| @deepseek-ai/dsh-session-snapshot | 0.1.3-alpha.2 |
...
| @deepseek-ai/dsh-session-title-all-prompts-llm | 0.1.3-alpha.2 |
...
| @deepseek-ai/dsh-storage-sqlite | 0.1.3-alpha.2 |
| @deepseek-ai/dsh-subagent | 0.1.3-alpha.2 |
| @deepseek-ai/dsh-subagent-acp | 0.1.3-alpha.2 |
| @deepseek-ai/dsh-subagent-claude-code | 0.1.3-alpha.2 |
| @deepseek-ai/dsh-subagent-codex | 0.1.3-alpha.2 |
| @deepseek-ai/dsh-subagent-dsh-sdk | 0.1.3-alpha.2 |
...
| @deepseek-ai/dsh-tool-lsp | 0.1.3-alpha.2 |
...
| @deepseek-ai/dsh-tool-session-query | 0.1.3-alpha.2 |
...
| @deepseek-ai/dsh-tool-terminal | 0.1.3-alpha.2 |
...
| @deepseek-ai/dsh-typert-generator | 0.1.3-alpha.2 |
...
| @deepseek-ai/dsh-web-search-perplexity | 0.1.3-alpha.2 |

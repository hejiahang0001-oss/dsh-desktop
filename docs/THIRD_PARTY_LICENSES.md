...
> Generated by `scripts/generate-third-party-licenses.cjs` from the exact V1.1.9 packaged runtime manifests. Do not edit package rows manually.
...
- JavaScript packages inventoried: **531**; no package in this fixed set is missing a declared license identifier.

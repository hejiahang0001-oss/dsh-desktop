...
> Generated by `scripts/generate-third-party-licenses.cjs` from the exact V1.1.1 packaged runtime manifests. Do not edit package rows manually.
...
- DeepSeek Harness: `@deepseek-ai/dsh@0.1.2-alpha.2`, source tag `dsh-v0.1.2-alpha.2`, commit `0a53fb55bea101816fa226bb964ae2bed71c343b`.
...
- JavaScript packages inventoried: **533**; no package in this fixed set is missing a declared license identifier.
...
| @deepseek-ai/dsh-acp | 0.1.2-alpha.2 |
| @deepseek-ai/dsh-acp-app | 0.1.2-alpha.2 |
...
| @deepseek-ai/dsh-agent-tool-presentation | 0.1.2-alpha.2 |
...
| @deepseek-ai/dsh-authorization | 0.1.2-alpha.2 |
...
| @deepseek-ai/dsh-client-web | 0.1.2-alpha.2 |
| @deepseek-ai/dsh-cmdline | 0.1.2-alpha.2 |
| @deepseek-ai/dsh-code-runtime | 0.1.2-alpha.2 |
| @deepseek-ai/dsh-code-runtime-python | 0.1.2-alpha.2 |
...
| @deepseek-ai/dsh-e2b | 0.1.2-alpha.2 |
...
| @deepseek-ai/dsh-hook-protocol | 0.1.2-alpha.2 |
| @deepseek-ai/dsh-hooks-claude-code | 0.1.2-alpha.2 |
| @deepseek-ai/dsh-hooks-codex | 0.1.2-alpha.2 |
...
| @deepseek-ai/dsh-llm-mock-server | 0.1.2-alpha.2 |
| @deepseek-ai/dsh-llm-pi-ai | 0.1.2-alpha.2 |
| @deepseek-ai/dsh-llm-replay | 0.1.2-alpha.2 |
...
| @deepseek-ai/dsh-persona | 0.1.2-alpha.2 |
...
| @deepseek-ai/dsh-sandbox-windows-acl | 0.1.2-alpha.2 |
| @deepseek-ai/dsh-schedule | 0.1.2-alpha.2 |
...
| @deepseek-ai/dsh-session-snapshot | 0.1.2-alpha.2 |
...
| @deepseek-ai/dsh-session-title-all-prompts-llm | 0.1.2-alpha.2 |
| @deepseek-ai/dsh-session-title-first-prompt-llm | 0.1.2-alpha.2 |
| @deepseek-ai/dsh-session-title-llm | 0.1.2-alpha.2 |
...
| @deepseek-ai/dsh-spill | 0.1.2-alpha.2 |
...
| @deepseek-ai/dsh-storage-sqlite | 0.1.2-alpha.2 |
| @deepseek-ai/dsh-subagent | 0.1.2-alpha.2 |
| @deepseek-ai/dsh-subagent-acp | 0.1.2-alpha.2 |
| @deepseek-ai/dsh-subagent-claude-code | 0.1.2-alpha.2 |
| @deepseek-ai/dsh-subagent-codex | 0.1.2-alpha.2 |
| @deepseek-ai/dsh-subagent-dsh-sdk | 0.1.2-alpha.2 |
...
| @deepseek-ai/dsh-time-context | 0.1.2-alpha.2 |
| @deepseek-ai/dsh-timeout | 0.1.2-alpha.2 |
| @deepseek-ai/dsh-tmux-context | 0.1.2-alpha.2 |
...
| @deepseek-ai/dsh-tool-cordis | 0.1.2-alpha.2 |
...
| @deepseek-ai/dsh-tool-lsp | 0.1.2-alpha.2 |
...
| @deepseek-ai/dsh-tool-session-query | 0.1.2-alpha.2 |
...
| @deepseek-ai/dsh-tool-terminal | 0.1.2-alpha.2 |
...
| @deepseek-ai/dsh-typert-generator | 0.1.2-alpha.2 |
...
| @deepseek-ai/dsh-util-workspace-path | 0.1.2-alpha.2 |
...
| @deepseek-ai/dsh-web-search-perplexity | 0.1.2-alpha.2 |
| @deepseek-ai/dsh-webhook | 0.1.2-alpha.2 |
| @deepseek-ai/dsh-webhook-github | 0.1.2-alpha.2 |
| @deepseek-ai/dsh-win32-process | 0.1.2-alpha.2 |

...
> Generated by `scripts/generate-third-party-licenses.cjs` from the exact V1.1.14 packaged runtime manifests. Do not edit package rows manually.
...
- Physical JavaScript manifest identities inventoried: **599**; no package in this fixed set is missing a declared license identifier. This count excludes dependencies embedded solely inside browser bundles.
...
- Native engine source: https://github.com/LibreOffice/core.git, revision `bce0998afefdbc355585ca324285661a2170ba77`. The verified prebuild manifest binds 2048 source/license/native files; no foreign-platform engine or silent WASM fallback is accepted.
...
| @deepseek-ai/dsh-client-web | 0.1.6-alpha.2 |
...
| @deepseek-ai/dsh-computer-use | 0.1.6-alpha.2 |
...
| @deepseek-ai/dsh-experimental-auto-review | 0.1.6-alpha.2 |
| @deepseek-ai/dsh-experimental-browser-use-chrome-devtools-mcp | 0.1.6-alpha.2 |
...
| @deepseek-ai/dsh-experimental-browser-use-stagehand-native | 0.1.6-alpha.2 |
| @deepseek-ai/dsh-experimental-client-ui-agent-team | 0.1.6-alpha.2 |
| @deepseek-ai/dsh-experimental-computer-use-cua-driver-mcp | 0.1.6-alpha.2 |
| @deepseek-ai/dsh-experimental-computer-use-cua-driver-native | 0.1.6-alpha.2 |
| @deepseek-ai/dsh-experimental-inspector | 0.1.6-alpha.2 |
| @deepseek-ai/dsh-experimental-ptc-runtime-python | 0.1.6-alpha.2 |
| @deepseek-ai/dsh-experimental-tool-agent-team | 0.1.6-alpha.2 |
| @deepseek-ai/dsh-experimental-webworker-packer | 0.1.6-alpha.2 |
| @deepseek-ai/dsh-experimental-webworker-runtime | 0.1.6-alpha.2 |
...
| @deepseek-ai/dsh-fs-ssh | 0.1.6-alpha.2 |
...
| @deepseek-ai/dsh-remote-mock | 0.1.6-alpha.2 |
...
| @deepseek-ai/dsh-sandbox-ssh | 0.1.6-alpha.2 |
...
| @deepseek-ai/dsh-session-snapshot | 0.1.6-alpha.2 |
...
| @deepseek-ai/dsh-session-title-all-prompts-llm | 0.1.6-alpha.2 |
...
| @deepseek-ai/dsh-ssh | 0.1.6-alpha.2 |
...
| @deepseek-ai/dsh-storage-sqlite | 0.1.6-alpha.2 |
| @deepseek-ai/dsh-subagent | 0.1.6-alpha.2 |
| @deepseek-ai/dsh-subagent-acp | 0.1.6-alpha.2 |
| @deepseek-ai/dsh-subagent-claude-code | 0.1.6-alpha.2 |
| @deepseek-ai/dsh-subagent-codex | 0.1.6-alpha.2 |
| @deepseek-ai/dsh-subagent-dsh-sdk | 0.1.6-alpha.2 |
...
| @deepseek-ai/dsh-subprocess-ssh | 0.1.6-alpha.2 |
...
| @deepseek-ai/dsh-tool-lsp | 0.1.6-alpha.2 |
...
| @deepseek-ai/dsh-tool-session-query | 0.1.6-alpha.2 |
...
| @deepseek-ai/dsh-tool-terminal | 0.1.6-alpha.2 |
...
| @deepseek-ai/dsh-typert-generator | 0.1.6-alpha.2 |
...
| @deepseek-ai/dsh-web-search-exa | 0.1.6-alpha.2 |
| @deepseek-ai/dsh-web-search-perplexity | 0.1.6-alpha.2 |

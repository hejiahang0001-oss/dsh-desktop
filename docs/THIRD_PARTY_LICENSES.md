...
> Generated by `scripts/generate-third-party-licenses.cjs` from the exact V1.1.11 packaged runtime manifests. Do not edit package rows manually.
...
- JavaScript packages inventoried: **553**; no package in this fixed set is missing a declared license identifier.
...
| @deepseek-ai/dsh-anonymous-user-id | 0.1.5-alpha.1 |
...
| @deepseek-ai/dsh-authorization | 0.1.5-alpha.1 |
...
| @deepseek-ai/dsh-client-web | 0.1.5-alpha.1 |
...
| @deepseek-ai/dsh-hook-protocol | 0.1.5-alpha.1 |
...
| @deepseek-ai/dsh-output-retention | 0.1.5-alpha.1 |
...
| @deepseek-ai/dsh-sandbox-windows-acl | 0.1.5-alpha.1 |
...
| @deepseek-ai/dsh-sdk-jsonrpc-server | 0.1.5-alpha.1 |
...
| @deepseek-ai/dsh-session-format-v1-to-v2 | 0.1.5-alpha.1 |
...
| @deepseek-ai/dsh-session-snapshot | 0.1.5-alpha.1 |
| @deepseek-ai/dsh-session-stats | 0.1.5-alpha.1 |
| @deepseek-ai/dsh-session-telemetry | 0.1.5-alpha.1 |
| @deepseek-ai/dsh-session-telemetry-otel | 0.1.5-alpha.1 |
| @deepseek-ai/dsh-session-title | 0.1.5-alpha.1 |
| @deepseek-ai/dsh-session-title-all-prompts-llm | 0.1.5-alpha.1 |
| @deepseek-ai/dsh-session-title-first-prompt-llm | 0.1.5-alpha.1 |
| @deepseek-ai/dsh-session-title-llm | 0.1.5-alpha.1 |
...
| @deepseek-ai/dsh-storage-sqlite | 0.1.5-alpha.1 |
| @deepseek-ai/dsh-subagent | 0.1.5-alpha.1 |
| @deepseek-ai/dsh-subagent-acp | 0.1.5-alpha.1 |
| @deepseek-ai/dsh-subagent-claude-code | 0.1.5-alpha.1 |
| @deepseek-ai/dsh-subagent-codex | 0.1.5-alpha.1 |
| @deepseek-ai/dsh-subagent-dsh-sdk | 0.1.5-alpha.1 |
...
| @deepseek-ai/dsh-tool-lsp | 0.1.5-alpha.1 |
...
| @deepseek-ai/dsh-tool-session-query | 0.1.5-alpha.1 |
...
| @deepseek-ai/dsh-tool-terminal | 0.1.5-alpha.1 |
...
| @deepseek-ai/dsh-typert-generator | 0.1.5-alpha.1 |
...
| @deepseek-ai/dsh-web-search-perplexity | 0.1.5-alpha.1 |
| @deepseek-ai/dsh-webhook | 0.1.5-alpha.1 |
| @deepseek-ai/dsh-webhook-github | 0.1.5-alpha.1 |
| @deepseek-ai/dsh-win32-process | 0.1.5-alpha.1 |

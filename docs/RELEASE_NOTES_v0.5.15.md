...
- The installer remains unsigned and automatic update remains fail-closed. GitHub PR/CI and remote-release evidence are recorded after those final remote gates complete. V0.5.4 remains the formal Stable and GitHub Latest release.

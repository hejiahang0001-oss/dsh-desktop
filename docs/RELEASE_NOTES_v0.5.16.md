...
- The installer remains unsigned and automatic update remains fail-closed. PR #24 and main-branch CI run 32820893222 pass. The non-draft [V0.5.16 Pre-release](https://github.com/hejiahang0001-oss/dsh-desktop/releases/tag/v0.5.16) targets `4266f248340d8378ad29b4bd4efb2176eef6c5e9`; all three downloaded assets exactly match local size and SHA-256, and the public installer returns HTTP 200 with content length 183,982,493.

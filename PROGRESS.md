...
> 日期：2026-08-30
> 当前构建：V1.0.1 本地产品 Latest 候选（已打包并覆盖安装，尚未发布 GitHub）
> 状态：V1.0.1 已完成本地源码、打包、回滚保护、覆盖安装和已安装应用验收；V1.0.0 继续作为 GitHub Pre-release，V0.5.4 继续保持 Stable 和 GitHub 正式 `Latest release`

## V1.0.1 当前进展（本地候选已安装，未发布）
...
| 回滚与发布边界 | `backups/pre-v1.0.1-20260830-170338` 保留 V1.0.0 回滚资产；`backups/pre-v1.0.1-redo-20260830-191216` 保留被替换的首个 V1.0.1 候选、治理报告和无凭据语义快照；安装器仍未签名，自动更新、PR/CI、GitHub 发布和公开回下载均未执行 |

...
## V1.1.14 alpha.2 适配预检（2026-09-18，未升级安装；等待新增依赖体积确认）
...
- 新增 Windows Office 引擎 npm 解压体积 340,863,092 字节（约 325.1 MiB），最终安装包增量未测。已请求维护者确认；确认前不下载引擎、不切换固定运行库或应用版本号、不打包覆盖。

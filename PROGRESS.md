...
## V1.1.12 Harness RC2 / 官方预览与交付（2026-09-11，发布验收中）
...
- PR #82、发布代码 main CI、传输工作流通过；GitHub 草稿 `386457813` 的四项资产大小和 SHA-256 与本机一致，临时差分资产已移除且本地保留。发布目标提交 `8ebccb74554d139354e12c8ffe4b14febd3327c6`。草稿未公开，不冒充已发布。
- **等待用户退出本机旧版 DSH（菜单“退出”，不是关到托盘）**；已通过异步问题告知，没有强制终止。当前读取到安装版本仍为 1.1.11.0。之后才做升级前备份、覆盖安装、安装态/真实文件检查、公开草稿及匿名完整回下载。续接见 `artifacts/v1.1.12-release-candidate/RESUME_AFTER_EXIT.md`。

...
- 视觉审查发现旧双侧面板在窄窗口下遮挡发送区，已补充实际横向按钮边界检查和窄窗口单侧优先规则，保留用户最后打开的面板。当前尚未宣称完成打包与发布。V1.0.5 和 V1.1 尚未交付。
...
- 最终包六项安装后验收通过，最终 app.asar 摘要 A974AEDCB90BEED4FD5540C52EAF4FFA4A3965FBAD8DA118DE171989085B47C2，安装与解包一致；公开资产上传中。

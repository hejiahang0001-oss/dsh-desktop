...
- 2026-08-31 已完成从 V1.0.2 到 V1.1.0 的五次版本交付。本机已覆盖 V1.1.0；403/403 源码门禁、最终包和已安装 UI/真实模型验收通过。GitHub Pre-release v1.1.0 目标 139fab49fab6e71cd648471863cbc28341a7e009，四个附件匿名回下载大小与 SHA-256 为 4/4 一致（artifacts/public-v1.1.0/verification.json）；本地清单 3/3 核对通过。Stable 和正式 Latest release 仍为 V0.5.4。
- 最终 Setup：188,767,301 字节，SHA-256 465208D87D3EA7C811C7E909AEC1ADA18850BB43A5ECE6BE0EE3B152B03CA6BC；Portable：188,075,787 字节，SHA-256 1F89D1F3C5BB981612C1019058B1FAAC6B66157F45F5DD57A5B36A5E5ADB470D。回滚包为 backups/pre-v1.1.0-20260831 中已验证的 V1.0.5；失败候选在 superseded-before-index-fix 中另存，未对外发布。
